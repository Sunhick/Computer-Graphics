...
void Cylinder(GLfloat radius, GLfloat height, GLubyte R, GLubyte G, GLubyte B) {
  ...
  while (angle < 2 * PI) {
    ...
    glTexCoord2f(rep * tc, 0);
    glVertex3f(x, y, height);
    glTexCoord2f(rep * tc, 1);
    glVertex3f(x, y, 0.0);
  ...
  while (angle < 2 * PI) {
    ...
    glTexCoord2f(rep * 0.5f * cos(angle) + 0.5f,
                 rep * 0.5f * sin(angle) + 0.5f);
    glVertex3f(x, y, height);
    angle = angle + angle_stepsize;
  }
  glVertex3f(radius, 0.0, height);
...
// * Draw cylinder
// **********************************************************/
// void Cylinder(GLfloat radius, GLfloat height, GLubyte R, GLubyte G, GLubyte
// B)
//{
//    GLfloat x              = 0.0;
//    GLfloat y              = 0.0;
...
//        y = radius * sin(angle);
//
//        glTexCoord2f( rep*0.5f * cos(angle) + 0.5f, rep * 0.5f * sin(angle) +
//        0.5f ); glVertex3f(x, y , height); angle = angle + angle_stepsize;
//    }
//    glVertex3f(radius, 0.0, height);
//    glEnd();
//
...
//
//        glTexCoord2f( -rep*0.5f * cos(angle) + 0.5f, rep * 0.5f * sin(angle) +
//        0.5f ); glVertex3f(-x, y , 0); angle = angle + angle_stepsize;
//    }
//    glVertex3f(radius, 0.0, height);
//    glEnd();
//}
...
struct Point3d computeNormal(struct Point3d p1, struct Point3d p2,
  ...
  return Normalize((struct Point3d){.x = p1.y * p2.z - p1.z * p2.y,
